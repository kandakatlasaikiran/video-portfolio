...
import csharpImage from "../assets/about/csharp.png";
import wordpressImage from "../assets/about/wordpress.png";
import shopifyImage from "../assets/about/shopify.png";
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-16 items-start">
        ...
        >
          ...
          <p className="text-lg font-bold mb-12 leading-relaxed max-w-3xl text-red-50">
            ...
            , a passionate full-stack developer based on Hyderabad, dedicated to
            crafting clean, functional, and highly scalable web applications.
          </p>
